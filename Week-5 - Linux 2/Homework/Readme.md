...
The following exercise involves knowledge of `cron`. Refer to the man and help files for `cron` in addition to Google should you choose to try this exercise.
